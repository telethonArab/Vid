...
2 - (.تشغيل_فيديو + الرد على الفيديو او كتابه اسم الفيديو )
...
6 - ( .تحميل_فيديو + رابط من اليوتيوب او اسم الفيديو )
7 - ( .تحميل + اسم الصوت او رابط من اليوتيوب )
8 - (.ادخل ) : لأنضمام حساب المساعد الى المجموعة
9 - (.اخرج ) : لخروج حساب المساعد من المجموعة
10- (.بث + ربط البث المباشر من اليوتيوب )"""
